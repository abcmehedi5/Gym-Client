...
const TreaningPrograms = () => {
    return (
        <div className='container mb-5'>
            <h1 className='text-center mb-5 myFont'>TRENING <span style={{ color: '#FCD842' }}>PROGRAMS</span></h1>\

            <div className="row">
                {
                    treningData.map(trening => <TreningProgramsDetails key={trening.title} trening={trening}></TreningProgramsDetails>)
                }
            </div>
        </div>
    );
